...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("allfile"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton("🔍 𝚂𝙴𝙰𝚁𝙲𝙷MOVIES 🔍", switch_inline_query_current_chat=''), 
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://github.com/Arshad-ek2/Ar-profeser-bot/edit/main/plugins/query.py')
            ],[
